...
[Learn more about Equal Weighting ](../strategies/equal.md)
{% endtab %}
...
[Learn more about Market Capitalization Weighting](../strategies/market-capitalization.md)
{% endtab %}
...
[Learn more about Maximum Sharpe Ratio Weighting](../strategies/maximum-sharpe-ratio.md)
{% endtab %}
...
[Learn more about Minimum Volatility Weighting](../strategies/minimum-volatility.md)
{% endtab %}
...
[Learn more about Efficient Return Weighting](../strategies/efficient-return.md)
{% endtab %}
...
[Learn more about Efficient Risk Weighting](../strategies/efficient-risk.md)
{% endtab %}
{% endtabs %}
...
[Learn more about Maximum Return / Minimum Volatility Weighting](../strategies/maximum-return-minimum-volatility.md)
{% endtab %}
...
[Learn more about Inverse Variance Weighting](../strategies/inverse-variance.md)
{% endtab %}
...
[Learn more about Maximum Diversification Weighting](../strategies/maximum-diversification.md)
{% endtab %}
...
[Learn more about Maximum Decorrelation Weighting](../strategies/maximum-decorrelation.md)
{% endtab %}
{% endtabs %}
